...
namespace Dominio.LogicaDelNegocio
{
    class RegistrarEmpleado
    {
        ...
        public void AdicionarEmpleado(string nombre,string apellido, int cedula,string cargo, DateTime fechanacimiento,string nombreConcesionario)
        {
        ...
        public void ActualizarEmpleado(string nombre, string apellido, int cedula, string cargo, DateTime fechanacimiento, Concesionario concesionario,string correo,string contraseña)
        {
            /*
        ...
        {   /*
            ...
            try
            {
                ...
                {
                    if (concesionario.vendedores[i].Cedula == cedula)
                    {
                        vendedoresAux.Add(concesionario.vendedores[i]);
                    }
                    else if (concesionario.vendedores[i].Nombre == nombre)
                    {
                        vendedoresAux.Add(concesionario.vendedores[i]);
                    }
                    else if (concesionario.vendedores[i].Apellido == apellido)
                    {
                        vendedoresAux.Add(concesionario.vendedores[i]);
                    }
                }
